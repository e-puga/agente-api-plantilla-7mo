...
public interface LogConversacionRepository extends JpaRepository<LogConversacion, Integer> {
	 ...
	 * ) List<LogConversacionDTO>
	 * buscarConversacionesPorIdentificacion(@Param("identificacion") String
	 * identificacion);
	 */
	 ...
	 * ) List<LogConversacionDTO>
	 * buscarUltimasConversacionesPorIdentificacion(@Param("identificacion") String
	 * identificacion);
	 */
